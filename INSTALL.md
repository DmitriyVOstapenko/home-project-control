...
- актуальная версия ChatGPT desktop app с Codex либо Codex CLI с командами `codex plugin`;
...
## Рекомендуемая установка из GitHub
...
Из корня клонированного репозитория добавьте локальный marketplace и установите плагин:
...
2. откройте её как рабочую папку новой задачи Codex;
...
Для установки из GitHub обновите снимок marketplace и переустановите актуальную версию:
